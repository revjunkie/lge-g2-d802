...
#define DEF_OPTIMAL_FREQ			(960000)
...
#ifndef CONFIG_CPU_FREQ_DEFAULT_GOV_LG_ONDEMAND
static
#endif
struct cpufreq_governor cpufreq_gov_lg_ondemand = {
       .name                   = "lg_ondemand",
...
static int __init cpufreq_gov_dbs_init(void)
{
	...
	return cpufreq_register_governor(&cpufreq_gov_lg_ondemand);
}
...
static void __exit cpufreq_gov_dbs_exit(void)
{
	...
	cpufreq_unregister_governor(&cpufreq_gov_lg_ondemand);
	for_each_possible_cpu(i) {
		struct cpu_dbs_info_s *this_dbs_info =
			&per_cpu(od_cpu_dbs_info, i);
...
#ifdef CONFIG_CPU_FREQ_DEFAULT_GOV_LG_ONDEMAND
